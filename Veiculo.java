...
class Carro extends Veiculo {
    ...
    public double calcularValorLocacao(int dias){
        ...
        System.out.println("O valor da locação de um carro para " + dias + " dias é de R$ " + valor);
        return valor;
    }
}
...
class Moto extends Veiculo {
    ...
    public double calcularValorLocacao(int dias){
        ...
        System.out.println("O valor da locação de uma moto para " + dias + " dias é de R$ " + valor);
        return valor;
    }
}
...
class Caminhao extends Veiculo {
    ...
    public double calcularValorLocacao(int dias){
        ...
        System.out.println("O valor da locação  de um caminhão para " + dias + " dias é de R$ " + valor);
        return valor;
    }
}
